...
void Server::connectCommandSend(std::vector<std::string> buffer,
  ...
  response = "Connect OK"; // ici faut faire la commande si le joeuur a reussi a ce connecté avec la map les entites ...
...
void Server::disconnectCommandSend(std::vector<std::string> buffer,
  ...
  response = "disconnect OK"; // ici faut faire la commande disconnect si un joeur dans la partie c'est deconnecté
...
void Server::newPlayerCommandSend(std::vector<std::string> buffer,
  ...
  response = "newPlayer OK"; // ici faut faire la commande si un joeur se connecte a la partie
...
void Server::moveCommandSend(std::vector<std::string> buffer,
  ...
  response = "Move OK"; // ici faut faire la commande move avec la nouvelle pos du player en cas de probleme;
...
void Server::shootCommandSend(std::vector<std::string> buffer,
  ...
  response = "Shoot OK"; // ici faut faire la commande shoot si le mec a le droit tiré
...
void Server::mapCommandSend(std::vector<std::string> buffer,
  ...
  response = "Map OK"; // ici faut faire la commande map qui retourne la map donc en gros toutes les pos des entites
