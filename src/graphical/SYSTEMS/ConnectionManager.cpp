...
void ConnectionManager::initialize(const std::string &tcpIp,
                                   std::size_t tcpPort,
...
std::unique_ptr<IProtocol> &ConnectionManager::getTcp() { return _tcp; }

std::unique_ptr<IProtocol> &ConnectionManager::getUdp() { return _udp; }
