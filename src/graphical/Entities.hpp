...
/**
 * @file Entities.hpp
 * @brief Declaration of the `Entities` class used to represent a unique entity in an Entity Component System (ECS).
 *
 * This class encapsulates an entity identifier as a `std::size_t`.
 * It provides functionalities to retrieve the entity's value and supports implicit conversion to `std::size_t`.
 */
...
public:
   ...
   *
   * This method allows an `Entities` instance to be used where a `std::size_t` is expected.
