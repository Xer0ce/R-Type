...
Cutscene::Cutscene(SDL_Renderer *renderer, std::string textureTalkingPath, std::string texturePath, float x, float y, float width, float height)
    : _textureTalkingPath(textureTalkingPath), _texturePath(texturePath), _x(x), _y(y), _width(width), _height(height), _renderer(renderer)
{
