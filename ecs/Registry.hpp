...
/**
 * @file Registry.hpp
 * @brief Declaration of the `Registry` class, a central manager for entities and their components.
 *
 * This class provides a system to manage entities and components within an Entity Component System (ECS).
 * It supports dynamic registration of component types, adding, removing, and accessing components for entities,
 * and managing the lifecycle of entities.
 */
 ...
 *
 * The `Registry` class facilitates the dynamic registration of components and the management of
 * their associations with entities. It handles entity creation, destruction, and component lifecycle operations.
 */
class Registry {
...
public:
     ...
     *
     * Registers a new component type `Component` in the registry. Each component type is associated with a
     * `SparseArray` to manage the component data.
     *
    ...
    /**
     * @brief Retrieves the `SparseArray` for a registered component type (const version).
     *
     * @tparam Component The component type to retrieve.
     * @return Const reference to the `SparseArray` of the specified component type.
     * @throws std::runtime_error If the component type is not registered.
     */
    template <class Component>
     ...
     *
     * Marks the entity as available for reuse and removes all associated components.
     *
...
private:
     ...
     *
     * These functions handle the removal of a specific component type from an entity.
     */
